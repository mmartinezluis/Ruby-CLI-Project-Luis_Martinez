...
Gem::Specification.new do |spec|
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata["source_code_uri"] = "git@github.com:mmartinezluis/quotes-app-cli.git"
    spec.metadata["changelog_uri"] = "git@github.com:mmartinezluis/quotes-app-cli.git"
  else
